...
- [DaisyUI](https://daisyui.com/) - learn about DaisyUI, our TailwindCSS component + theme library

### wagmi.sh

To learn more about WAGMI, take a look at the following resources:

- [wagmi.sh](https://wagmi.sh) - learn about wagmi.sh, react hooks for Ethereum
